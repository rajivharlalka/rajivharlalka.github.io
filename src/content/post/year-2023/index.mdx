...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
  <div style="flex-basis: calc(50% - 20px); margin: 10px; box-sizing: border-box;">
    <img src={flight.src} alt="Flight" style="width: 100%; height: auto; display: block;" />
  </div>
  <div style="flex-basis: calc(50% - 20px); margin: 10px; box-sizing: border-box;">
    <img src={house.src} alt="House" style="width: 100%; height: auto; display: block;" />
  </div>
  <div style="flex-basis: 100%; margin: 10px; box-sizing: border-box;">
    <img src={personal.src} alt="Personal" style="width: 100%; height: auto; display: block;" />
  </div>
</div>
